"""
test_CheFSI.py — Test script for the CheFSI FrontierSolver.
Generates a 1D distorted chain, computes reference eigenvalues/eigenvectors via
scipy.linalg.eigh, and compares GPU-computed frontier orbitals with diagnostics
for convergence, orthogonality, and condition number.
"""
import argparse
import numpy as np
