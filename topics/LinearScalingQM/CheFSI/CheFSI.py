"""
CheFSI.py — GPU-accelerated Chebyshev Filtering Subspace Iteration solver.
Finds frontier orbitals (HOMO/LUMO) of large sparse Hamiltonians using PyOpenCL
with ELLPACK sparse format and Chebyshev polynomial filtering.
"""
import numpy as np
