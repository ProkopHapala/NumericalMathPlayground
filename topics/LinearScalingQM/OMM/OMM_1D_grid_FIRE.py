"""
OMM_1D_grid_FIRE.py — 1D grid-based OMM solver with FIRE acceleration.
Uses the Fast Inertial Relaxation Engine to adaptively adjust time-step and
mixing parameters for faster convergence of localized orbital optimization.
"""
import numpy as np
