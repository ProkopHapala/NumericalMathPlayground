/*
OMM.cl — OpenCL kernels for the Orbital Minimization Method (3-phase design).
Phase 1: apply_operator  — computes dual vectors |phi'> = Op |phi> on expanded supports.
Phase 2: project_orbitals — computes scalar overlaps <phi_i | phi'_j>.
Phase 3: assemble_gradient — combines scalars and duals into final gradient.
*/
// =========================================================================
