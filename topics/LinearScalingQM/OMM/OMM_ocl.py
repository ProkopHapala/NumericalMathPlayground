"""
OMM_ocl.py — Orbital Minimization Method using PyOpenCL (GPU-accelerated).

Minimizes an unconstrained energy functional with respect to localized molecular
orbitals (LMOs). The gradient calculation is split into 3 kernels to avoid atomic
operations: (1) apply_operator, (2) project_orbitals, (3) assemble_gradient.
Supports sparse orbital supports with expanded supports for H/S interactions.
"""
import numpy as np
