"""
OMM.py — Pure Python reference implementation of the Orbital Minimization Method.
Uses explicit loops (C-style) for clarity and as a porting reference for the GPU version.
Handles orbital masks, neighbor lists, sparse matrix-vector products, and Jacobi
orthogonalization for localized orbitals with finite support.
"""
import numpy as np
