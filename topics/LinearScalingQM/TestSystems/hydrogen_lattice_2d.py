"""
hydrogen_lattice_2d.py — 2D hydrogen lattice test system for Order-N methods.
Builds a 2D triangular lattice with tight-binding parameters for testing
linear-scaling density matrix and orbital solvers in two dimensions.
"""
import sys
