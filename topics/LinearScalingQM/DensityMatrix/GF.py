"""
GF.py — Green's Function methods for linear-scaling density matrix computation.
Uses contour integration in the complex plane with deterministic probing (comb-based)
and stochastic random-probe variants. Solves linear systems at each contour node.
"""
import numpy as np
