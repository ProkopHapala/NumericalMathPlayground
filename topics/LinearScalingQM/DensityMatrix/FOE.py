"""
FOE.py — Fermi Operator Expansion for linear-scaling density matrix computation.
Approximates the Fermi-Dirac function via Chebyshev polynomials and uses stochastic
trace estimation (Rademacher probes) to compute the density matrix diagonal without
