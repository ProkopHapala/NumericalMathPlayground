"""
OrderN.py — Shared utilities for Order-N electronic structure calculations.
Provides tight-binding parameter generation, neighbor pair finding, sparse matrix
assembly, generalized eigenvalue solver, spectral bounds estimation, linear solvers
(Jacobi, Cholesky), and plotting helpers.
"""
import numpy as np
