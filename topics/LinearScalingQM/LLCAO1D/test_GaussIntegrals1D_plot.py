"""
test_GaussIntegrals1D_plot.py — Validation of 1D Gaussian basis integrals.
Compares analytical formulas (overlap, kinetic energy, Coulomb) against
numerical grid integration for various inter-center distances.
"""
