"""
run_localized.py — Demo script for the localized orbital solver.
Sets up a 1D atom chain with Gaussian basis, runs iterative localized orbital
optimization, and plots the resulting localized molecular orbitals.
"""
import numpy as np
