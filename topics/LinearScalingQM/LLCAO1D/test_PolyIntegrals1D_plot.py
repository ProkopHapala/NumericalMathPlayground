"""test_PolyIntegrals1D_plot.py — Validation of 1D polynomial basis integrals.
Compares analytical formulas against numerical grid integration for polynomial
basis functions used in 1D quantum mechanics.
"""
# /home/prokop/git/FireCore/doc/py/LLCAO1D/test_PolyIntegrals1D_plot.py
