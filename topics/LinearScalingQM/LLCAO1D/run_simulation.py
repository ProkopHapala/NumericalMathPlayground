"""
run_simulation.py — Demo script for the standard diagonalization solver.
Sets up a 1D atom chain with Gaussian basis, runs full diagonalization,
and plots the resulting molecular orbitals.
"""
