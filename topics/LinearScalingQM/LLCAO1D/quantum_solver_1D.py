"""
quantum_solver_1D.py — 1D quantum solver using LCAO with Gaussian basis functions.
Provides analytical integrals (overlap, kinetic, Coulomb) and both standard
diagonalization and iterative localized orbital optimization methods.
"""
import numpy as np
