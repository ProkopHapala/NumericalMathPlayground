"""
Truss.py — Utilities for building and assembling spring-mass truss systems.
Provides triangular grid generation, stiffness matrix assembly, and edge extraction.
Used as a mechanical analogy for quantum lattice problems in VibrationProbing.py.
"""
import numpy as np
